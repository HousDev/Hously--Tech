    ...
    <div className="space-y-5 sm:space-y-6 lg:space-y-8">
      ...
      <div className="bg-gradient-to-br from-[#0076d8]/5 to-[#ffd801]/5 rounded-2xl sm:rounded-3xl p-5 sm:p-6 lg:p-8 hover:shadow-xl transition duration-300 border border-gray-100">
        <div className="flex items-start space-x-4">
          <div className="w-14 h-14 lg:w-16 lg:h-16 bg-gradient-to-br from-[#0076d8] to-[#0066c0] rounded-2xl flex items-center justify-center shadow-lg">
            <ThumbsUp className="w-7 h-7 lg:w-8 lg:h-8 text-white" />
          </div>
          <div>

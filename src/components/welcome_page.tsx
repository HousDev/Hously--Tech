...
//                       >
//                         <div
//                           className={`w-full sm:w-5/12 md:w-2/5 lg:w-1/3 ${isRight
          ...
          <div className="container mx-auto px-3 sm:px-4 md:px-6 py-0">
              ...
              <div className="max-w-6xl mx-auto w-full">
                <div className="text-center">
                  ...
                  >
                    ...
                    {/* Pillars - FIXED: Added proper typing for colorMap */}
                    <div className="flex flex-wrap justify-center gap-3 sm:gap-4 md:gap-6 mt-4 sm:mt-5 px-4">
                      {[
                        { label: "Real Estate", icon: Building2, color: "indigo" },
                        { label: "Finance", icon: TrendingUp, color: "emerald" },
                        ...
                        const Icon = pillar.icon;
                        // FIX: Add proper type annotation for colorMap
                        ...
                        return (
                          ...
                          >
                            ...
                            <div className={`relative px-4 sm:px-6 py-3 sm:py-4 bg-white border border-slate-200 rounded-2xl 
                                hover:shadow-lg ${colors.border} transition-all duration-300
                                hover:shadow-${pillar.color}-100`}>
                              <div className="flex items-center gap-2 sm:gap-3">
                                <div className={`relative p-1.5 sm:p-2 ${colors.bg} rounded-lg group-hover:rotate-[360deg] 
                                    transition-transform duration-700 ease-in-out overflow-hidden`}>
            ...
            <div className="mt-12 sm:mt-20 md:mt-25 mb-0">
              ...
              <div className="max-w-8xl mx-auto px-2 sm:px-3 md:px-4">
                ...
                {/* DESKTOP VIEW - Original Layout - FIXED: Added type assertion for TimelineDot */}
                <div className="hidden sm:block relative overflow-hidden w-full">
                  {/* Timeline SVG / Moving Dot - FIXED: Added type assertion */}
                  <TimelineDot {...{ cardRefs: timelineRefs } as any} />
                  ...
                  {timeline.map((item, index) => {
                    ...
                    return (
                      <div
                        key={index}
                        // FIXED: Fixed ref callback to return void

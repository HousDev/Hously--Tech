          ...
          <div className="bg-slate-800/50 backdrop-blur-sm rounded-2xl p-8 space-y-8 text-slate-300">
            ...
            <section>
              ...
              <ul className="list-disc list-inside space-y-2 ml-4">
                ...
                <li>Apply for financing or investment opportunities</li>
              </ul>
            ...
            <section>
              ...
              <ul className="list-disc list-inside space-y-2 ml-4">
                ...
                <li><strong>Business Partners:</strong> We may share information with trusted business partners to provide you with products or services</li>

...
//       {/* About Section */}
//       <section className="pt-17 md:pt-1 pb-16 md:pb-20 lg:pb-12 bg-white">
//         <div className="flex flex-wrap items-start -mr-[40px] -ml-[40px] px-24">
//           {/* Left Column - Images */}
//           <div className="w-full lg:w-6/12 px-[90px] mt-[20px] flex-shrink-0 max-w-full">
...
//                   {Array.from("Hously - IT SOLUTIONS - TECHNOLOGY & INNOVATION.").map(
//                     (char, index) => (
//                       <span
//                         key={index}
...
//                   className="z-10 inline-flex items-center justify-center w-[56px] h-[56px] rounded-full bg-white text-[#6D30FB]"
//                 >
//                   <i className="fa-solid fa-play text-[1.2rem]" />
//                 </a>
//               </div>
...
//           <div className="w-full lg:w-6/12 px-[40px] mt-[20px] flex-shrink-0 max-w-full">
//             <div className="relative z-20 mb-[30px]">
//               <span className="inline-block text-[#0076d8] font-medium uppercase tracking-wider mb-6 animate-[slideInLeft_900ms_ease_200ms_both]">
//                 About Us
//               </span>

//               <h2 className="text-[54px] leading-tight font-bold mb-4 animate-[slideInLeft_900ms_ease_300ms_both]">
//                 Comprehensive IT Services for Modern Business Transformation
//               </h2>

//               <p className="text-[#6F756D] leading-[1.75] animate-[slideInUp_900ms_ease_400ms_both]">
...
//                 <div className="inline-flex items-center justify-start pb-4">
...
//               <a
//                 href="#"
//                 className="inline-flex items-center justify-center py-[21px] px-[30px] rounded-full bg-[#0076d8] text-white font-medium"
//               >
//                 More About Us
...
//       <section className="relative overflow-hidden bg-[#F5F5F5] pt-4 md:pt-6 lg:pt-16 pb-8 md:pb-12 lg:pb-8">
//         {/* Background Image */}
//         <div
...
//             {/* Right Column - Content */}
//             <div className="w-full lg:w-6/12 px-4 md:px-6 lg:px-8 mt-0 flex-shrink-0 max-w-full">
//               <div className="relative z-20 mb-5 md:mb-6 lg:mb-8 mt-0">
//                 {/* Subtitle */}
...
//                 {/* Title */}
//                 <h2 className="text-[#051600] text-3xl md:text-4xl lg:text-5xl xl:text-[64px] leading-tight font-bold mt-0 mb-2 opacity-0 animate-[slideInUp_900ms_ease_0ms_both]">
//                   How Does it Work?
//                 </h2>

//                 {/* Description */}
//                 <p className="mt-2 text-[#6F756D] text-sm md:text-base leading-relaxed md:leading-[1.75] opacity-0 animate-[slideInUp_900ms_ease_0ms_both]">
...
//                   reliable results that align with your business goals.
//                 </p>
//               </div>
